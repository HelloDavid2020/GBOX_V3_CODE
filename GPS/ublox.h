...
#define     GPS_POWER_INIT      P3DIR |= BIT6;P1DIR |= BIT4
#define     GPS_POWER_ON        P3OUT |= BIT6;P1OUT |= BIT4
#define     GPS_POWER_OFF       P3OUT &= ~BIT6;P1OUT &= ~BIT4
#define     GPS_POWER_RESET     P3DIR &= ~BIT6;P1DIR &= ~BIT4
